...
from model import img2tex
from utils import dataloader, metrics, utils
...
def main():
    ...
    if checkpoint is None:
        encoder = img2tex.Encoder()
        encoder_optimizer = torch.optim.Adam(params=filter(lambda p: p.requires_grad, encoder.parameters()),
                                             lr=encoder_lr)

        decoder = img2tex.DecoderWithAttention(attention_dim=attention_dim,
                                               embed_dim=emb_dim,
